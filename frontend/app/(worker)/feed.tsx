...
export default function FeedScreen({
  ...
  const handleBulkFeed = () => {
    ...
    Alert.alert(
      "Mark as Fed",
      `Mark ${selectedIds.size} cow${selectedIds.size > 1 ? "s" : ""} as fed for ${shift} shift?`,
      [
            ...
            <View style={s.bannerLeft}>
              ...
              <View>
                ...
                <Text style={s.bannerShift}>
                  {shift === "morning" ? "🌅" : "🌙"} {shift.toUpperCase()}{" "}
                  SHIFT
                </Text>
              </View>
            </View>
            ...
            {selectMode ? (
              ...
              >
                ...
                >
                  ...
                  <Text style={s.feedAllText}>Feed All Cows</Text>
                      ...
                      <View style={s.feedSection}>
                        <View style={s.feedSectionHeader}>
                          <FontAwesome5
                            ...
                            color="#ca8a04"
                          />
                          <Text style={s.feedSectionLabel}>Feed Schedule</Text>
