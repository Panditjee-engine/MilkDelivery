...
function QRActionSheet({
  ...
  const handleLinkExisting = async () => {
    ...
    setLinking(true);
    try {
      const updated = await api.linkQRToCow(
        selectedCow.id,
        qrData,
        scannedIsBarcode,
      );
...
const lh = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: "#5C3D2E", fontSize: 16, fontWeight: "700" },
  sortBtn: {
    width: 50,
    height: 50,
    borderRadius: 16,
  ...
  countText: { fontSize: 13, fontWeight: "800", color: "#BB6B3F" },
  ...
  filterChipImg: { width: 22, height: 22, resizeMode: "contain" },
  filterChipText: { fontSize: 13, color: "#8B6854", fontWeight: "800" },
...
const f = StyleSheet.create({
  ...
  focused: { borderColor: "#FFBF55", backgroundColor: "#fff", borderWidth: 2.5 },
  input: { flex: 1, color: "#5C3D2E", fontSize: 16, fontWeight: "700" },
  toggleRow: {
    flexDirection: "row",
    alignItems: "center",
    justifyContent: "space-between",
  ...
  todayText: { fontSize: 12, fontWeight: "800", color: "#BB6B3F" },
  pickerOverlay: {
    flex: 1,
...
const bd = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: "#111827", fontSize: 16, fontWeight: "700" },
  item: {
    flexDirection: "row",
    alignItems: "center",
    paddingHorizontal: 16,
...
const tr = StyleSheet.create({
  ...
  toggleLabel: { fontSize: 15, fontWeight: "800", color: "#7c3aed" },
  toggleSub: { fontSize: 11, fontWeight: "500", marginTop: 2 },
  fields: {
    paddingHorizontal: 14,
    paddingBottom: 14,
...
const sd = StyleSheet.create({
  ...
  toggleLabel: { fontSize: 15, fontWeight: "800", color: "#ea580c" },
  toggleSub: { fontSize: 11, fontWeight: "500", marginTop: 2 },
  fields: {
    paddingHorizontal: 14,
    paddingBottom: 14,
...
const ex = StyleSheet.create({
  ...
  toggleLabel: { fontSize: 15, fontWeight: "800", color: "#dc2626" },
  toggleSub: { fontSize: 11, fontWeight: "500", marginTop: 2 },
  fields: {
    paddingHorizontal: 14,
    paddingBottom: 14,
...
const qa = StyleSheet.create({
  ...
  searchInput: { flex: 1, color: "#8B6854", fontSize: 16, fontWeight: "700" },
  cowRow: {
    flexDirection: "row",
    alignItems: "center",
    paddingHorizontal: 14,
