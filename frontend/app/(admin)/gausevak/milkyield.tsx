    ...
    >
      <View style={rd.overlay}>
        <View style={rd.sheet}>
          ...
          <Text style={rd.sub}>
            Full admin dashboard for complete milk records and analytics.
          </Text>
          <View style={rd.urlRow}>
            <Ionicons name="link-outline" size={12} color="#9ca3af" />
            <Text style={rd.url} numberOfLines={1}>
              gausatv.com/admin-dashboard
            </Text>
          </View>
          ...
          <Text style={rd.countdown}>
            Redirecting in <Text style={rd.countdownNum}>{countdown}s</Text>
          </Text>
      ...
      {DATE_OPTIONS.map((d) => {
        ...
        return (
          <TouchableOpacity
            key={d}
            onPress={() => onChange(d)}
            style={[df.chip, isActive && df.chipActive]}
          >
            {isActive && (
              <Ionicons
            ...
            <Text style={[df.chipText, isActive && df.chipTextActive]}>
              {formatDateLabel(d)}
            </Text>
          </TouchableOpacity>
        );
    ...
    >
      ...
      >
        ...
        <View style={md.sheet}>
          ...
          <Text style={md.hint}>
            Expected maximum daily milk yield for this cow (in litres).
          </Text>
      ...
      <View style={ie.controlRow}>
        ...
        >
          {saving ? (
            ...
            <Text style={[ie.saveTxt, { color: isDirty ? "#fff" : color }]}>
              Save
            </Text>
          )}
        </TouchableOpacity>
    ...
    setMilkRows((prev) =>
      prev.map((row) => {
        ...
        return shift === "morning"
          ? { ...row, morningLiters: liters }
          : { ...row, eveningLiters: liters };
      }),
    );
    setSummary((prev) => {
      ...
      return {
        ...prev,
        total_morning:
          shift === "morning" ? prev.total_morning + delta : prev.total_morning,
        total_evening:
          shift === "evening" ? prev.total_evening + delta : prev.total_evening,
